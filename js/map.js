...
/*	var map = L.map('map').setView([19.4329, -99.1331], 11);
	...
	//var circle = L.circle([19.4680261, -99.18417569], {
	//	color: 'red',
	//	fillColor: '#f03',
	//	fillOpacity: 0.5,
	//	radius: 50
	//}).addTo(map);
	//circle.bindPopup("Delito");


*/

d3.csv('datos/crime-lat-long_v2.csv', function (error, incidents) {
            ...
            var cscale = d3.scale.linear().domain([1, 3]).range(["#fff", "#fff", "#fff", "#fff", "#00ffff", "#0094ff"]);//"#00FF00","#FFA500"
            var leafletMap = L.map('map').setView([19.4329, -99.1331], 11);
